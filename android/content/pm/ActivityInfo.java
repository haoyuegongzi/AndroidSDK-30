...
/**
 * Information you can retrieve about a particular application activity or receiver. This corresponds
 * to information collected from the AndroidManifest.xml's &lt;activity&gt; and &lt;receiver&gt; tags.
 * 您可以检索有关特定应用程序活动或接收器的信息。 这对应于从 AndroidManifest.xml 的 、activity、and、receiver、tags 收集的信息。
 */
